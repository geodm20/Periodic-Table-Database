...
--
-- Name: properties atomic_number_properties_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_number_properties_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
